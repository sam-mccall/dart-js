class ProxyJs {
  ...
  initialize(String prototypeName) {
    this.prototypeName = prototypeName; // TODO: process these prototype names
    //to create each object. (ie google.maps.Map)
    _id = _nextIdNum++;
  }
  ...
  ProxyJs([String prototypeName = null, List args]) {
    ...
    // TODO: autogen these functions called prototypeName_new for constructors.
  ...
  /**
   * Private constructor, only used to update a new version of an object.
   */
  ProxyJs._update(this._id, this.prototypeName); // TODO: args?
